...
function ProjectCard({ project }) {
  ...
  return (
    <div className="from-[#0d1224] relative rounded-lg border bg-gradient-to-r to-gray-700 w-full">
      ...
      <div className="px-4 lg:px-8 py-3 lg:py-5 relative">
        ...
        <p className="text-center ml-3 text-gray-200 text-base lg:text-xl">
          {project.name}
        </p>
      </div>
